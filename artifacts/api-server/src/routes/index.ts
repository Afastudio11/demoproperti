...
import planningStagesRouter from "./planning-stages";
import planningLandbankRouter from "./planning-landbank";
import planningSiteplanRouter from "./planning-siteplan";
...
router.use(planningStagesRouter);
router.use(planningLandbankRouter);
router.use(planningSiteplanRouter);
