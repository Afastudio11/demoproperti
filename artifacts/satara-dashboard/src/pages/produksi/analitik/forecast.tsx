...
export default function AnalitikForecast() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div><h2 className="text-base font-semibold mb-1">Forecast Penyelesaian Produksi</h2><p className="text-sm text-muted-foreground">Proyeksi penyelesaian konstruksi berdasarkan velocity rata-rata</p></div>
